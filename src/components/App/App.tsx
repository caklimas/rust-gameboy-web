    ...
    render() {
        return (
            <div className='app'>
                {/* <RomLoader />
                <Gameboy /> */}
                <Multitouch id='target1' text='Tap, Hold or Swipe me 1' />
                <Multitouch id='target2' text='Tap, Hold or Swipe me 2' />
                <Multitouch id='target3' text='Tap, Hold or Swipe me 3' />
                <Multitouch id='target4' text='Tap, Hold or Swipe me 4' />
            </div>
        );
    }
}
